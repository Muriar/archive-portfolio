...
import { HeroGrid } from "./Background/BackgroundGrid";
...
function SectionSatu() {
  return (
          <div className="space-y-10 pt-12">
            ...
            >
              Motion / Editing / Vibe Coder
            </p>

            <h1
              className="text-center items-center text-[clamp(4.4rem,17vw,11rem)] leading-[0.86] tracking-[-0.07em] uppercase text-stone-100"
            ...
            >
              ...
              <span className="overflow-hidden text-stone-300">
                <span data-hero-line className="block">
                  digitalku
                </span>
              </span>
            ...
            <p
              data-hero-meta
              className="text-center items-center text-sm leading-7 text-stone-300 sm:text-base"
            >
              Tempat dimana saya akan menceritakan awal mula segalanya, dari kapan saya mulai belajar dan berkarya, dan kapan saya mulai aktif dalam mencari cara agar saya dapat berkembang menjadi individu yang lebih produktif. Saya akan menceritakan bagaimana saya menjadi seorang editor yang juga meruoakan seorang Website and Software Developer juga seorang FullStack Enggineer dan sejak kapan saya memulainya.
            </p>
          </div>
...
export default function TimelinePage({ onSectionChange }: menuProps) {
