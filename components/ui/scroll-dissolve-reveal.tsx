...
const Scene = ({ imageFront, imageBack, scrollYProgress }: SceneProps) => {
    ...
    () => ({
      ...
      uImageResolution: {
        value: new THREE.Vector2(
          (texture1.image as HTMLImageElement | undefined)?.width ?? 1,
          (texture1.image as HTMLImageElement | undefined)?.height ?? 1
        ),
      },
      uDissolve: { value: 0.0 },
  ...
  const uniforms2 = useMemo(
    () => ({
      ...
      uImageResolution: {
        value: new THREE.Vector2(
          (texture2.image as HTMLImageElement | undefined)?.width ?? 1,
          (texture2.image as HTMLImageElement | undefined)?.height ?? 1
        ),
      },
      uDissolve: { value: 0.0 },
      uCenter: { value: new THREE.Vector2(0.5, 0.5) },
